    ...
    '$timeout', function ($timeout) {
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                select_branch = function (branch, is_dbl_click) {
                    if (!branch) {
                    ...
                    if (branch !== selected_branch) {
                        ...
                        if (branch.onSelect != null) {
                            return $timeout(function () {
                                return branch.onSelect(branch, is_dbl_click);
                            });
                        } else {
                            if (scope.onSelect != null) {
                                return $timeout(function () {
                                    branch.is_dbl_click = is_dbl_click;
                ...
                scope.user_clicks_branch = function (branch) {
                    $timeout(function () {
                        if (scope.clicked === true && scope.clickCount === 2) {
                            scope.clicked = false;
                            return;
                        } else {
                            if (scope.clickCount) {
                ...
                scope.user_double_clicks_branch = function (branch) {
                    ...
                    if (branch !== selected_branch) {
                        return select_branch(branch, true);
                    }
                };
